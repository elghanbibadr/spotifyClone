...
const PlayIcon = (props) => {
  return (
    <div onClick={props.onClick} className='bg-lighterAccent cursor-pointer flex h-16 justify-center w-16 p-4 items-center relative bottom-3 rounded-full lg:w-20 lg:h-20'>
